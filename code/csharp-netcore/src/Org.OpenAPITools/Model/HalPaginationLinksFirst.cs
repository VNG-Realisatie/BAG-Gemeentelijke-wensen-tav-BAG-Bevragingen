...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HalPaginationLinksFirst :  IEquatable<HalPaginationLinksFirst>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HalPaginationLinksFirst" /> class.
        /// </summary>
        /// <param name="href">href.</param>
        /// <param name="templated">templated.</param>
        /// <param name="title">title.</param>
        public HalPaginationLinksFirst(string href = default(string), bool templated = default(bool), string title = default(string))
        {
            this.Href = href;
        ...
        {
            return this.Equals(input as HalPaginationLinksFirst);
        }

        /// <summary>
        /// Returns true if HalPaginationLinksFirst instances are equal
        /// </summary>
        /// <param name="input">Instance of HalPaginationLinksFirst to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HalPaginationLinksFirst input)
        {
            if (input == null)
                return false;
