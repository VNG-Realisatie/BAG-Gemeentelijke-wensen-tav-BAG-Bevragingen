...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdresHal :  IEquatable<AdresHal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdresHal" /> class.
        /// </summary>
        ...
        public AdresHal(string straat = default(string), int huisnummer = default(int), string huisletter = default(string), string huisnummertoevoeging = default(string), string postcode = default(string), string woonplaats = default(string), string korteNaam = default(string), string nummeraanduidingIdentificatie = default(string), string openbareRuimteIdentificatie = default(string), string woonplaatsIdentificatie = default(string), string adresseerbaarObjectIdentificatie = default(string), List<string> pandIdentificaties = default(List<string>), bool isNevenadres = default(bool), bool geconstateerd = default(bool), AdresMogelijkOnjuist mogelijkOnjuist = default(AdresMogelijkOnjuist), AdresLinks links = default(AdresLinks), AdresEmbedded embedded = default(AdresEmbedded))
        {
            this.Straat = straat;
        ...
        public AdresLinks Links { get; set; }
        ...
        {
            return this.Equals(input as AdresHal);
        }

        /// <summary>
        /// Returns true if AdresHal instances are equal
        /// </summary>
        /// <param name="input">Instance of AdresHal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdresHal input)
        {
            if (input == null)
                return false;
