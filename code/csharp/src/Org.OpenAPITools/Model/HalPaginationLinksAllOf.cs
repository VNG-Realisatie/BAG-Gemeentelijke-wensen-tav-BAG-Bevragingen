...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class HalPaginationLinksAllOf :  IEquatable<HalPaginationLinksAllOf>, IValidatableObject
    {
        ...
        public HalPaginationLinksAllOf(HalPaginationLinksFirst first = default(HalPaginationLinksFirst), HalPaginationLinksPrevious previous = default(HalPaginationLinksPrevious), HalPaginationLinksNext next = default(HalPaginationLinksNext))
        {
            this.First = first;
