...
public class AdresApi {
     ...
     * @param postcode Postcode van het adres. (optional)
     * @param huisnummer Huisnummer van het adres. (optional)
     * @param huisletter Een toevoeging (in de vorm van een letter) aan een huisnummer van het adres. Bijvoorbeeld:  Bij adres: Belgiëlaan 1 A2, 2391 PH  HAZERSWOUDE-DORP, is 1 het huisnummer en A de huisletter.  (optional)
     * @param huisnummertoevoeging Een toevoeging (in de vorm van maximaal 4 cijfers of letters) aan een huisnummer of een combinatie van huisnummer en huisletter van het adres. Bijvoorbeeld:  Bij het adres: Belgiëlaan 1 A2, 2391 PH  HAZERSWOUDE-DORP, is 1 het huisnummer, A de huisletter en 2 de huisnummertoevoeging.  (optional)
     * @param exacteMatch \&quot;Geeft aan of de resultaten van de zoekopdracht exact overeen moeten komen met de opgegeven parameters, zie [functionele specificatie exacte match](https://github.com/lvbag/BAG-API/blob/master/Features/exacte_match.feature).\&quot; (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call raadpleegAdressenCall(String pandIdentificatie, String adresseerbaarObjectIdentificatie, String zoekresultaatIdentificatie, String expand, String fields, Integer page, Integer pageSize, String postcode, Integer huisnummer, String huisletter, String huisnummertoevoeging, Boolean exacteMatch, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (exacteMatch != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("exacteMatch", exacteMatch));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call raadpleegAdressenValidateBeforeCall(String pandIdentificatie, String adresseerbaarObjectIdentificatie, String zoekresultaatIdentificatie, String expand, String fields, Integer page, Integer pageSize, String postcode, Integer huisnummer, String huisletter, String huisnummertoevoeging, Boolean exacteMatch, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = raadpleegAdressenCall(pandIdentificatie, adresseerbaarObjectIdentificatie, zoekresultaatIdentificatie, expand, fields, page, pageSize, postcode, huisnummer, huisletter, huisnummertoevoeging, exacteMatch, _callback);
        return localVarCall;
     ...
     */
    public AdresHalCollectie raadpleegAdressen(String pandIdentificatie, String adresseerbaarObjectIdentificatie, String zoekresultaatIdentificatie, String expand, String fields, Integer page, Integer pageSize, String postcode, Integer huisnummer, String huisletter, String huisnummertoevoeging, Boolean exacteMatch) throws ApiException {
        ApiResponse<AdresHalCollectie> localVarResp = raadpleegAdressenWithHttpInfo(pandIdentificatie, adresseerbaarObjectIdentificatie, zoekresultaatIdentificatie, expand, fields, page, pageSize, postcode, huisnummer, huisletter, huisnummertoevoeging, exacteMatch);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AdresHalCollectie> raadpleegAdressenWithHttpInfo(String pandIdentificatie, String adresseerbaarObjectIdentificatie, String zoekresultaatIdentificatie, String expand, String fields, Integer page, Integer pageSize, String postcode, Integer huisnummer, String huisletter, String huisnummertoevoeging, Boolean exacteMatch) throws ApiException {
        okhttp3.Call localVarCall = raadpleegAdressenValidateBeforeCall(pandIdentificatie, adresseerbaarObjectIdentificatie, zoekresultaatIdentificatie, expand, fields, page, pageSize, postcode, huisnummer, huisletter, huisnummertoevoeging, exacteMatch, null);
     ...
     */
    public okhttp3.Call raadpleegAdressenAsync(String pandIdentificatie, String adresseerbaarObjectIdentificatie, String zoekresultaatIdentificatie, String expand, String fields, Integer page, Integer pageSize, String postcode, Integer huisnummer, String huisletter, String huisnummertoevoeging, Boolean exacteMatch, final ApiCallback<AdresHalCollectie> _callback) throws ApiException {

        okhttp3.Call localVarCall = raadpleegAdressenValidateBeforeCall(pandIdentificatie, adresseerbaarObjectIdentificatie, zoekresultaatIdentificatie, expand, fields, page, pageSize, postcode, huisnummer, huisletter, huisnummertoevoeging, exacteMatch, _callback);
        Type localVarReturnType = new TypeToken<AdresHalCollectie>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param woonplaatsidentificatie De identificatie van een woonplaats. (required)
     * @param expand Hiermee kun je opgeven welke gerelateerde resources meegeleverd moeten worden, en hun inhoud naar behoefte aanpassen. Hele resources of enkele properties geef je in de expand parameter kommagescheiden op. Properties die je wil ontvangen geef je op met de resource-naam gevolgd door de property naam, met daartussen een punt. In de definitie van het antwoord kun je bij _embedded zien welke gerelateerde resources meegeleverd kunnen worden. Zie [functionele specificaties](https://github.com/VNG-Realisatie/Haal-Centraal-common/blob/v1.2.0/features/expand.feature). (optional)
     * @param fields Hiermee kun je de inhoud van de resource naar behoefte aanpassen door een door komma&#39;s gescheiden lijst van property namen op te geven. Bij opgave van niet-bestaande properties wordt een 400 Bad Request teruggegeven. Wanneer de fields parameter niet is opgegeven, worden alle properties met een waarde teruggegeven. Zie [functionele specificaties](https://github.com/VNG-Realisatie/Haal-Centraal-common/blob/v1.2.0/features/fields.feature) (optional)
