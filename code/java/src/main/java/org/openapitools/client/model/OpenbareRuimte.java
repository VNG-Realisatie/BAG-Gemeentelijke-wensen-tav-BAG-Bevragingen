...
public class OpenbareRuimte {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Tue Feb 09 01:00:00 CET 2010", value = "De vaststellingsdatum van het brondocument dat de basis is voor opname, wijziging of een verwijdering van een object.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "BAG-21", value = "De unieke aanduiding van het brondocument op basis waarvan een opname, mutatie of een verwijdering van gegevens ten aanzien van een woonplaats heeft plaatsgevonden, binnen een gemeente. Alle karakters uit de MES-1 karakterset zijn toegstaan.")
