...
public class ApiClient {
    ...
    private String basePath = "https://api.bag.acceptatie.kadaster.nl/esd/huidigebevragingen/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("apiKeyBAG", new ApiKeyAuth("header", "X-Api-Key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.bag.acceptatie.kadaster.nl/esd/huidigebevragingen/v1
