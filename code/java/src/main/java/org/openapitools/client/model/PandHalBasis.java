...
import org.openapitools.client.model.Pand;
import org.openapitools.client.model.PandHalBasisAllOf;
import org.openapitools.client.model.PandLinks;
...
public class PandHalBasis {
  ...
  private PandLinks links;


  public PandHalBasis identificatie(String identificatie) {
  ...
  **/
  ...
  public PandHalBasis domein(String domein) {
  ...
  **/
  ...
  public PandHalBasis geometrie(PolygonGeoJSON geometrie) {
  ...
  **/
  ...
  public PandHalBasis oorspronkelijkBouwjaar(Integer oorspronkelijkBouwjaar) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1991", value = "Het jaar waarin een pand oorspronkelijk als bouwkundig gereed is wordt opgeleverd. Door de gemeente wordt een inschatting gemaakt van het bouwjaar, en aangepast als het pand wordt opgeleverd. Wijzigingen aan een pand na oplevering leiden niet tot wijziging van het bouwjaar.")
  ...
  public PandHalBasis status(StatusPandEnum status) {
  ...
  **/
  ...
  public PandHalBasis geconstateerd(Boolean geconstateerd) {
  ...
  **/
  ...
  public PandHalBasis documentdatum(LocalDate documentdatum) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Tue May 12 02:00:00 CEST 2009", value = "De vaststellingsdatum van het brondocument dat de basis is voor opname, wijziging of een verwijdering van een object.")
  ...
  public PandHalBasis documentnummer(String documentnummer) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "09.BW.0273", value = "De unieke aanduiding van het brondocument op basis waarvan een opname, mutatie of een verwijdering van gegevens ten aanzien van een woonplaats heeft plaatsgevonden, binnen een gemeente. Alle karakters uit de MES-1 karakterset zijn toegstaan.")
  ...
  public PandHalBasis adresseerbaarObjectIdentificaties(List<String> adresseerbaarObjectIdentificaties) {
    
    this.adresseerbaarObjectIdentificaties = adresseerbaarObjectIdentificaties;
    return this;
  }

  public PandHalBasis addAdresseerbaarObjectIdentificatiesItem(String adresseerbaarObjectIdentificatiesItem) {
  ...
  **/
  ...
  public PandHalBasis nummeraanduidingIdentificaties(List<NummeraanduidingIdentificatiesArray> nummeraanduidingIdentificaties) {
    
    this.nummeraanduidingIdentificaties = nummeraanduidingIdentificaties;
    return this;
  }

  public PandHalBasis addNummeraanduidingIdentificatiesItem(NummeraanduidingIdentificatiesArray nummeraanduidingIdentificatiesItem) {
  ...
  **/
  ...
  public PandHalBasis mogelijkOnjuist(PandMogelijkOnjuist mogelijkOnjuist) {
  ...
  **/
  ...
  public PandHalBasis links(PandLinks links) {
  ...
  **/
  ...
  public PandLinks getLinks() {
    return links;
  }


  public void setLinks(PandLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PandHalBasis pandHalBasis = (PandHalBasis) o;
    return Objects.equals(this.identificatie, pandHalBasis.identificatie) &&
        Objects.equals(this.domein, pandHalBasis.domein) &&
        Objects.equals(this.geometrie, pandHalBasis.geometrie) &&
        Objects.equals(this.oorspronkelijkBouwjaar, pandHalBasis.oorspronkelijkBouwjaar) &&
        Objects.equals(this.status, pandHalBasis.status) &&
        Objects.equals(this.geconstateerd, pandHalBasis.geconstateerd) &&
        Objects.equals(this.documentdatum, pandHalBasis.documentdatum) &&
        Objects.equals(this.documentnummer, pandHalBasis.documentnummer) &&
        Objects.equals(this.adresseerbaarObjectIdentificaties, pandHalBasis.adresseerbaarObjectIdentificaties) &&
        Objects.equals(this.nummeraanduidingIdentificaties, pandHalBasis.nummeraanduidingIdentificaties) &&
        Objects.equals(this.mogelijkOnjuist, pandHalBasis.mogelijkOnjuist) &&
        Objects.equals(this.links, pandHalBasis.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identificatie, domein, geometrie, oorspronkelijkBouwjaar, status, geconstateerd, documentdatum, documentnummer, adresseerbaarObjectIdentificaties, nummeraanduidingIdentificaties, mogelijkOnjuist, links);
  }
