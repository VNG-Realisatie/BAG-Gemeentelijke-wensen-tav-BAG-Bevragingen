...
/**
 * Eigenschappen van het adres die kunnen worden hergebruikt in andere API&#39;s met adresgegevens.
 */
@ApiModel(description = "Eigenschappen van het adres die kunnen worden hergebruikt in andere API's met adresgegevens.")
