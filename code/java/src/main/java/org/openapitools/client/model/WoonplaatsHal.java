...
import org.openapitools.client.model.WoonplaatsHalAllOf;
import org.openapitools.client.model.WoonplaatsHalBasis;
import org.openapitools.client.model.WoonplaatsLinks;
...
public class WoonplaatsHal {
  ...
  public WoonplaatsHal identificatie(String identificatie) {
  ...
  **/
  ...
  public WoonplaatsHal domein(String domein) {
  ...
  **/
  ...
  public WoonplaatsHal naam(String naam) {
  ...
  **/
  ...
  public WoonplaatsHal status(StatusWoonplaatsEnum status) {
  ...
  **/
  ...
  public WoonplaatsHal geconstateerd(Boolean geconstateerd) {
  ...
  **/
  ...
  public WoonplaatsHal documentdatum(LocalDate documentdatum) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Mon Feb 09 01:00:00 CET 2009", value = "De vaststellingsdatum van het brondocument dat de basis is voor opname, wijziging of een verwijdering van een object.")
  ...
  public WoonplaatsHal documentnummer(String documentnummer) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "09.0898", value = "De unieke aanduiding van het brondocument op basis waarvan een opname, mutatie of een verwijdering van gegevens ten aanzien van een woonplaats heeft plaatsgevonden, binnen een gemeente. Alle karakters uit de MES-1 karakterset zijn toegstaan.")
  ...
  public WoonplaatsHal mogelijkOnjuist(WoonplaatsMogelijkOnjuist mogelijkOnjuist) {
  ...
  **/
  ...
  public WoonplaatsHal links(WoonplaatsLinks links) {
  ...
  **/
  ...
  public WoonplaatsLinks getLinks() {
    return links;
  }


  public void setLinks(WoonplaatsLinks links) {
    this.links = links;
  }


  public WoonplaatsHal embedded(WoonplaatsEmbedded embedded) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WoonplaatsHal woonplaatsHal = (WoonplaatsHal) o;
    return Objects.equals(this.identificatie, woonplaatsHal.identificatie) &&
        Objects.equals(this.domein, woonplaatsHal.domein) &&
        Objects.equals(this.naam, woonplaatsHal.naam) &&
        Objects.equals(this.status, woonplaatsHal.status) &&
        Objects.equals(this.geconstateerd, woonplaatsHal.geconstateerd) &&
        Objects.equals(this.documentdatum, woonplaatsHal.documentdatum) &&
        Objects.equals(this.documentnummer, woonplaatsHal.documentnummer) &&
        Objects.equals(this.mogelijkOnjuist, woonplaatsHal.mogelijkOnjuist) &&
        Objects.equals(this.links, woonplaatsHal.links) &&
        Objects.equals(this.embedded, woonplaatsHal.embedded);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identificatie, domein, naam, status, geconstateerd, documentdatum, documentnummer, mogelijkOnjuist, links, embedded);
  }
