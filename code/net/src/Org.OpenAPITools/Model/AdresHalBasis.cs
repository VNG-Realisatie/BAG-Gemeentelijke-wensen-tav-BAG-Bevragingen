...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdresHalBasis :  IEquatable<AdresHalBasis>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdresHalBasis" /> class.
        /// </summary>
        ...
        public AdresHalBasis(string straat = default(string), int huisnummer = default(int), string huisletter = default(string), string huisnummertoevoeging = default(string), string postcode = default(string), string woonplaats = default(string), string korteNaam = default(string), string nummeraanduidingIdentificatie = default(string), string openbareRuimteIdentificatie = default(string), string woonplaatsIdentificatie = default(string), string adresseerbaarObjectIdentificatie = default(string), List<string> pandIdentificaties = default(List<string>), bool isNevenadres = default(bool), bool geconstateerd = default(bool), AdresMogelijkOnjuist mogelijkOnjuist = default(AdresMogelijkOnjuist), AdresLinks links = default(AdresLinks))
        {
            this.Straat = straat;
        ...
        {
            return this.Equals(input as AdresHalBasis);
        }

        /// <summary>
        /// Returns true if AdresHalBasis instances are equal
        /// </summary>
        /// <param name="input">Instance of AdresHalBasis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdresHalBasis input)
        {
            if (input == null)
                return false;
