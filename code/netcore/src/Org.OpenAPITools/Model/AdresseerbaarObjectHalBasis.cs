...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdresseerbaarObjectHalBasis")]
    public partial class AdresseerbaarObjectHalBasis : IEquatable<AdresseerbaarObjectHalBasis>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdresseerbaarObjectHalBasis" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AdresseerbaarObjectHalBasis);
        }

        /// <summary>
        /// Returns true if AdresseerbaarObjectHalBasis instances are equal
        /// </summary>
        /// <param name="input">Instance of AdresseerbaarObjectHalBasis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdresseerbaarObjectHalBasis input)
        {
            if (input == null)
                return false;
