...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NummeraanduidingHalBasis")]
    public partial class NummeraanduidingHalBasis : IEquatable<NummeraanduidingHalBasis>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NummeraanduidingHalBasis" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NummeraanduidingHalBasis);
        }

        /// <summary>
        /// Returns true if NummeraanduidingHalBasis instances are equal
        /// </summary>
        /// <param name="input">Instance of NummeraanduidingHalBasis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NummeraanduidingHalBasis input)
        {
            if (input == null)
                return false;
