...
namespace Org.OpenAPITools.Model
{
    ...
    /// WoonplaatsHal
    /// </summary>
    [DataContract(Name = "WoonplaatsHal")]
    public partial class WoonplaatsHal : IEquatable<WoonplaatsHal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WoonplaatsHal" /> class.
        /// </summary>
        ...
        public WoonplaatsHal(string identificatie = default(string), string domein = default(string), string naam = default(string), StatusWoonplaatsEnum status = default(StatusWoonplaatsEnum), bool geconstateerd = default(bool), DateTime documentdatum = default(DateTime), string documentnummer = default(string), WoonplaatsMogelijkOnjuist mogelijkOnjuist = default(WoonplaatsMogelijkOnjuist), WoonplaatsLinks links = default(WoonplaatsLinks), WoonplaatsEmbedded embedded = default(WoonplaatsEmbedded))
        {
        ...
        {
            return this.Equals(input as WoonplaatsHal);
        }

        /// <summary>
        /// Returns true if WoonplaatsHal instances are equal
        /// </summary>
        /// <param name="input">Instance of WoonplaatsHal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WoonplaatsHal input)
        {
            if (input == null)
                return false;
