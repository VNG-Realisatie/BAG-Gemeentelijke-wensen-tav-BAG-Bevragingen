    ...
    def __init__(self, api_client=None):
        ...
        def __raadpleeg_adressen(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                postcode (str): Postcode van het adres.. [optional]
                huisnummer (int): Huisnummer van het adres.. [optional]
                huisletter (str): Een toevoeging (in de vorm van een letter) aan een huisnummer van het adres. Bijvoorbeeld:  Bij adres: Belgiëlaan 1 A2, 2391 PH  HAZERSWOUDE-DORP, is 1 het huisnummer en A de huisletter. . [optional]
                huisnummertoevoeging (str): Een toevoeging (in de vorm van maximaal 4 cijfers of letters) aan een huisnummer of een combinatie van huisnummer en huisletter van het adres. Bijvoorbeeld:  Bij het adres: Belgiëlaan 1 A2, 2391 PH  HAZERSWOUDE-DORP, is 1 het huisnummer, A de huisletter en 2 de huisnummertoevoeging. . [optional]
                exacte_match (bool): \"Geeft aan of de resultaten van de zoekopdracht exact overeen moeten komen met de opgegeven parameters, zie [functionele specificatie exacte match](https://github.com/lvbag/BAG-API/blob/master/Features/exacte_match.feature).\". [optional] if omitted the server will use the default value of False
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
            ...
            root_map={
                'validations': {
                    ...
                    ('postcode',): {
                        ...
                        'regex': {
                            'pattern': r'^[1-9]{1}[0-9]{3}[a-zA-Z]{2}$',  # noqa: E501
                        },
                    },
                    ('huisnummer',): {
        ...
        def __raadpleeg_woonplaats(
            ...
            **kwargs
            ...
            Args:
                woonplaatsidentificatie (str): De identificatie van een woonplaats.
