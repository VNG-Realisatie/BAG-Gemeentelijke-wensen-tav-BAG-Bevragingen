...
class StatusPandEnum(object):
    ...
    allowable_values = [BOUWVERGUNNING_VERLEEND, BOUW_GESTART, PAND_IN_GEBRUIK_NIET_INGEMETEN_, PAND_IN_GEBRUIK, VERBOUWING_PAND, SLOOPVERGUNNING_VERLEEND, PAND_BUITEN_GEBRUIK]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """StatusPandEnum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StatusPandEnum):
            return False
