...
class TypeOpenbareRuimteEnum(object):
    ...
    allowable_values = [WEG, WATER, SPOORBAAN, TERREIN, KUNSTWERK, LANDSCHAPPELIJK_GEBIED, ADMINISTRATIEF_GEBIED]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """TypeOpenbareRuimteEnum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TypeOpenbareRuimteEnum):
            return False
