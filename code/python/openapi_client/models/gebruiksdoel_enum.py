...
class GebruiksdoelEnum(object):
    ...
    allowable_values = [WOONFUNCTIE, BIJEENKOMSTFUNCTIE, CELFUNCTIE, GEZONDHEIDSZORGFUNCTIE, INDUSTRIEFUNCTIE, KANTOORFUNCTIE, LOGIESFUNCTIE, ONDERWIJSFUNCTIE, SPORTFUNCTIE, WINKELFUNCTIE, OVERIGE_GEBRUIKSFUNCTIE]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """GebruiksdoelEnum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GebruiksdoelEnum):
            return False
