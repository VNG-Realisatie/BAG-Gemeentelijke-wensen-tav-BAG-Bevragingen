...
class StatusWoonplaatsEnum(object):
    ...
    allowable_values = [WOONPLAATS_AANGEWEZEN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """StatusWoonplaatsEnum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StatusWoonplaatsEnum):
            return False
