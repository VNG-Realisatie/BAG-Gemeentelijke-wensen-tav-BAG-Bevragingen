...
class AdresseerbaarObjectStatusEnum(object):
    ...
    allowable_values = [PLAATS_AANGEWEZEN, VERBLIJFSOBJECT_GEVORMD, VERBLIJFSOBJECT_IN_GEBRUIK_NIET_INGEMETEN_, VERBLIJFSOBJECT_IN_GEBRUIK, VERBOUWING_VERBLIJFSOBJECT, VERBLIJFSOBJECT_BUITEN_GEBRUIK]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AdresseerbaarObjectStatusEnum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdresseerbaarObjectStatusEnum):
            return False
