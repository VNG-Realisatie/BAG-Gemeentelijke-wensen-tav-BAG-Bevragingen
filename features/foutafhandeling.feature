...
Rule: min waarde mag niet kleiner zijn dan toegestane minimum waarde
    ...
    Abstract scenario: opgegeven minimum waarde lager dan toegestane minimum waarde
        ...
        Voorbeelden:
        | path      | query string                                                                      | parameter        | code    | reason omschrijving            |
        | /panden   | '/panden?bbox=134647,457842,135127,458307&oppervlakte[min]=0&oppervlakte[max]=200 | oppervlakte[min] | minimum | Waarde is lager dan minimum 1. |
        | /panden   | '/panden?bbox=134647,457842,135127,458307&bouwjaar[min]=-1&bouwjaar[max]=2000     | oppervlakte[min] | minimum | Waarde is lager dan minimum 0. |
        | /panden   | '/panden?bbox=134647,457842,135127,458307&oppervlakte[min]=0&oppervlakte[max]=0   | oppervlakte[max] | minimum | Waarde is lager dan minimum 1. |
        | /panden   | '/panden?bbox=134647,457842,135127,458307&bouwjaar[min]=-1&bouwjaar[max]=-1       | oppervlakte[max] | minimum | Waarde is lager dan minimum 0. |
...
Rule: max waarde mag niet groter zijn dan toegestane maximum waarde
    ...
    Abstract scenario: opgegeven maximum waarde groter dan toegestane maximum waarde
        ...
        Voorbeelden:
        | path      | query string                                                                                | parameter        | code    | reason omschrijving                  |
        | /panden   | '/panden?bbox=134647,457842,135127,458307&oppervlakte[min]=1000000&oppervlakte[max]=1000000 | oppervlakte[min] | maximum | Waarde is hoger dan maximum 1000000. |
        | /panden   | '/panden?bbox=134647,457842,135127,458307&bouwjaar[min]=10000&bouwjaar[max]=10000           | oppervlakte[min] | maximum | Waarde is hoger dan maximum 10000.   |
        | /panden   | '/panden?bbox=134647,457842,135127,458307&oppervlakte[min]=100&oppervlakte[max]=1000000     | oppervlakte[max] | maximum | Waarde is hoger dan maximum 1000000. |
        | /panden   | '/panden?bbox=134647,457842,135127,458307&bouwjaar[min]=1000&bouwjaar[max]=10000            | oppervlakte[max] | maximum | Waarde is hoger dan maximum 10000.   |
